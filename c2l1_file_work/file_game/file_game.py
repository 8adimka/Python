...
with open (r'C:\Users\m8adi\Desktop\Python\C2L1\file_game\words.txt', 'r') as file:
    for line in file:
...
with open (r'C:\Users\m8adi\Desktop\Python\C2L1\file_game\history.txt', 'a+', encoding='utf-8') as file:
