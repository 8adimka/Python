...
UPLOAD_FOLDER = '/home/v/Python/C3L2/static/uploads'  # путь к папке для сохранения изображений
FILE_DB = '/home/v/Python/C3L2/publications.json'  # Путь к JSON-файлу для сохранения данных
password_path = '/home/v/Python/C3L2/password_base.json' # Путь к JSON-файлу для сохранения логинов и паролей
