            ...
            prompts = [
                {
                    ...
                    "text": """
                        Это продолжение общения не надо здороваться или реагировать на это сообщение, мы просто продолжаем разговор и ты задаёшь следующий вопрос.
                ...
                },
                {
                    ...
                    "text": """
                        Это продолжение общения не надо здороваться или реагировать на это сообщение, мы продолжаем разговор.
